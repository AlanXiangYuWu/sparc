...
<p align="center">
  ...
  <br>
  <em>Figure 3: Architecture of the RMHA communication module.</em>
</p>
...
**Step 3: Policy loss** — clipped surrogate objective:
...
<p align="center">
  ...
  <br>
  <em>Figure 7: Communication ablation — training reward curves.</em>
</p>

<p align="center">
  <img src="paper/figures/ablation-sr-mappo-vs-graphcomm.png" width="45%"/>
  <img src="paper/figures/ablation-sr-rmha-vs-graphcomm.png" width="45%"/>
  <br>
  <em>Figure 8: Communication ablation — success rate comparison. Left: MAPPO vs. Graph Comm. Right: RMHA vs. Graph Comm.</em>
</p>
...
<p align="center">
  <img src="paper/figures/comparison-sr.png" width="500"/>
  <br>
  <em>Figure 9: Success rate comparison across algorithms on Warehouse and City/Game maps.</em>
</p>

<p align="center">
  <img src="paper/figures/comparison-max-reached.png" width="500"/>
  <br>
  <em>Figure 10: Maximum goals reached across algorithms on Warehouse and City/Game maps.</em>
</p>
...
<p align="center">
  <img src="paper/figures/trajectory-comparison.png" width="600"/>
  <br>
  <em>Figure 11: Global trajectory comparison — RMHA (left) vs. MAPPO (right).</em>
</p>
...
> **代码开源**: 代码将在论文录用后公开发布。目前论文正在 IROS 2026 双盲审稿阶段。
...
<p align="center">
  ...
  <img src="paper/figures/ablation-sr-rmha-vs-graphcomm.png" width="45%"/>
  <br>
  <em>图 8: 通信消融 — 成功率对比。左：MAPPO vs. 图通信。右：RMHA vs. 图通信。</em>
</p>
...
<p align="center">
  <img src="paper/figures/comparison-sr.png" width="500"/>
  <br>
  <em>图 9: 各算法在 Warehouse 和 City/Game 地图上的成功率对比。</em>
</p>

<p align="center">
  <img src="paper/figures/comparison-max-reached.png" width="500"/>
  <br>
  <em>图 10: 各算法在 Warehouse 和 City/Game 地图上的最大到达目标数。</em>
</p>
...
<p align="center">
  <img src="paper/figures/trajectory-comparison.png" width="600"/>
  <br>
  <em>图 11: 全局轨迹对比 — RMHA（左）vs. MAPPO（右）。</em>
</p>
